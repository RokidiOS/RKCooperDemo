...
target 'RKCooperDemo' do
  ...
  # pod 'RKRTC', :git => "https://github.com/RokidiOS/RKRTC", :branch => '1.3.0_swift5.6.0'
  ## 维护最新的两个Swift版本，需要拉取对应版本的sdk，目前支持5.5.2、5.6.0
  pod 'RKRTC', :git => "https://github.com/RokidiOS/RKRTC", :branch => '1.3.0_swiftx.x.x'
  
  ## 协作 sdk
  # pod 'RKCooperationCore', :path => '../../../RKCore/RKCooperationCore'
  # pod 'RKCooperationCore', :path => '../RKCooperationCore'
  # pod 'RKCooperationCore', :git => "https://github.com/RokidiOS/RKCooperationCore", :branch => '2.2.0_swift5.6.0'
  ## 维护最新的两个Swift版本，需要拉取对应版本的sdk，目前支持5.5.2、5.6.0
  pod 'RKCooperationCore', :git => "https://github.com/RokidiOS/RKCooperationCore", :branch => '2.2.0_swiftx.x.x'
